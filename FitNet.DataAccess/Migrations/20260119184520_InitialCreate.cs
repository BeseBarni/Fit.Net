...
namespace FitNet.DataAccess.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EquipmentContraIndication",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EquipmentContraIndication", x => new { x.ContraIndicationListId, x.EquipmentListId });
                    table.ForeignKey(
                        name: "FK_EquipmentContraIndication_ContraIndication_ContraIndication~",
                        column: x => x.ContraIndicationListId,
                        principalTable: "ContraIndication",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EquipmentContraIndication_Equipment_EquipmentListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseContraIndication", x => new { x.ContraIndicationListId, x.ExerciseListId });
                    table.ForeignKey(
                        name: "FK_ExerciseContraIndication_ContraIndication_ContraIndicationL~",
                        column: x => x.ContraIndicationListId,
                        principalTable: "ContraIndication",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExerciseContraIndication_Exercise_ExerciseListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EquipmentContraIndication_EquipmentListId",
                table: "EquipmentContraIndication",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseContraIndication_ExerciseListId",
                table: "ExerciseContraIndication",
